...
const AboutPage = () => {
  return (
    <section className="my-6">
      <div className="text-center max-w-[1500px] px-4 mx-auto">
        {/* Header */}
        ...
        <p className="text-lg text-gray-700 mb-3">
          Hello! I'm{" "}
          <span className="text-[#F7602C] font-semibold">Sarfaraz Akram</span>,
          a dedicated and passionate full-stack web developer from Bangladesh.
        </p>
          ...
          <div className="bg-white border-2 border-transparent hover:border-[#BF5B1F] p-8 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-[1.02] cursor-pointer">
            <div className="flex items-center gap-4 mb-4">
              <Image
                ...
                width={70}
              />
              <h4 className="text-2xl font-bold text-[#F7602C]">
                Sam's Kitchen
              </h4>
            </div>
            <p className="text-gray-700 mb-4 leading-relaxed">
